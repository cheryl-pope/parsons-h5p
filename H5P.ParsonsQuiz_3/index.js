    ...
    ParsonsQuiz.prototype.attach = function($container) {
        ...
        for (let i = 0; i < this.options.quiz.length; i++) {
            ...
            if (problem.fill_in_blank) {
                //testcase 1 edition
                var vars_string1 = problem.fill_text.test_cases.testcase1.variables;
                ...
                //testcase 2 edition
                var vars_string2 = problem.fill_text.test_cases.testcase2.variables;
            ...
            if (problem.fill_in_blank) {
                var fill = {
                    'vartests': [{
                            initcode: problem.fill_text.test_cases.testcase1.initcode,
                            code: "",
                            message: problem.fill_text.test_cases.testcase1.message,
                            variables: final1
                        },
                        {
                            initcode: problem.fill_text.test_cases.testcase2.initcode,
                            code: "",
                            message: problem.fill_text.test_cases.testcase2.message,
                            variables: final2
                        }
                    ],
                    'grader': ParsonsJS.ParsonsWidget._graders.LanguageTranslationGrader,
                    'executable_code': problem.fill_text.test,
